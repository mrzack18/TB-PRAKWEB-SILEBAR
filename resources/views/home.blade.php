    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 relative z-10">
        <div class="text-center max-w-3xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('auctions.index') }}" class="px-8 py-4 bg-surface text-primary font-bold rounded-full text-lg shadow-lg hover:bg-gray-50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 transform">
                    Mulai Menawar
                </a>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
    ...
    <div class="bg-surface rounded-2xl shadow-xl p-8 mb-16 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <a href="{{ route('auctions.index', ['category' => $category->id]) }}" class="group block p-6 bg-background rounded-xl hover:bg-blue-50 dark:hover:bg-gray-800 hover:shadow-md transition-all duration-300 text-center border border-transparent hover:border-blue-100 dark:hover:border-gray-700 transform hover:-translate-y-1">
                ...
                <h3 class="text-text-main font-semibold group-hover:text-primary transition-colors">{{ $category->name }}</h3>
    ...
    <div class="mb-16">
        <div class="flex justify-between items-end mb-8">
            ...
            <a href="{{ route('auctions.index') }}" class="group flex items-center text-primary font-semibold hover:text-blue-700 transition-colors">
                Lihat Semua 
            ...
            <div class="bg-surface rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col h-full">
                ...
                <div class="p-5 flex-1 flex flex-col">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-sm text-text-muted truncate">{{ $auction->seller->name }}</span>
                    </div>
                    ...
                    <div class="mt-auto border-t border-gray-100 dark:border-gray-700 pt-4">
                        <div class="flex justify-between items-end mb-4">
                            ...
                            <div class="text-right">
                                <p class="text-xs text-text-muted mb-1">{{ $auction->bids->count() }} bid</p>
                            </div>
                        </div>
                        
                        <a href="{{ route('auctions.show', $auction) }}" class="block w-full text-center py-2.5 bg-gray-900 dark:bg-primary dark:hover:bg-primary-dark text-white rounded-lg font-medium hover:bg-accent transition-colors shadow-lg shadow-gray-200 dark:shadow-none hover:shadow-orange-200">
                            Tawar Sekarang
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-surface rounded-2xl p-12 text-center shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            @auth
                @if(auth()->user()->role === 'seller')
                    <a href="{{ route('seller.auctions.create') }}" class="inline-flex items-center px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                        Buat Lelang Baru
                    </a>
                @elseif(auth()->user()->role === 'buyer')
                    <a href="{{ route('auctions.index') }}" class="inline-flex items-center px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
                        Mulai Belanja
                    </a>
                @endif
            @else
                <a href="{{ route('login') }}" class="inline-flex items-center px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                    Mulai Berjualan
                </a>
            @endauth
