...
@section('title', 'Cara Kerja - SILEBAR')
        ...
        <div class="mt-20 bg-primary rounded-3xl p-12 text-center relative overflow-hidden">
            <div class="relative z-10">
                ...
                <div class="flex justify-center gap-4">
                    <a href="{{ route('register') }}" class="bg-white text-primary font-bold py-3 px-8 rounded-full hover:bg-gray-100 transition-colors">
                        Daftar Sekarang
                    </a>
                    <a href="{{ route('auctions.index') }}" class="bg-blue-700 text-white font-bold py-3 px-8 rounded-full hover:bg-blue-800 transition-colors border border-blue-500">
                        Lihat Lelang
                    </a>
                </div>
            </div>
